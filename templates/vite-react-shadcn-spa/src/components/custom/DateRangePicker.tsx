...
import { type DateRange as CalendarRange, DateLib, DayButton, type DayButtonProps } from "react-day-picker"
...
const { format, isAfter, isBefore, startOfDay } = new DateLib()
